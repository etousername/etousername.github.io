...
var round = 1;
	...
	alert("Тебе нужно просто кликать по голубым квадратикам и находить два одинаковых рисунка. С каждым раундом время уменьшается на 30 секунд. Не правильно выбранные клетки -50 очков, правильно +100 очков.(если ты с телефона, переведи устройство в горизонтальный режим) \n Удачи!")
